 ...
 * Original file: /npm/lil-gui@0.18.2/dist/lil-gui.esm.js
 *
...
const n = {
	...
	l = {
		...
		toHexString: ([t, i, e], n = 1) =>
			s.toHexString(((t * (n = 255 / n)) << 16) ^ ((i * n) << 8) ^ (e * n)),
	},
	r = {
		isPrimitive: !1,
		match: (t) => Object(t) === t,
...
//# sourceMappingURL=/sm/29762e0468b834749a99081eb1fe1770764d7bd341be5860f4d3b788e1e5e383.map
