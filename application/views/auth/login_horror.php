...
<html lang="en" data-preloader="enable">
    ...
    <body
        style="background-image: url(<?php echo base_url(); ?>assets/images/sidebar/halloween.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;">
        ...
        <script type="module">
            ...
            const params = {
                size: .04,
                tail: { dotsNumber: 25, spring: 1.5, friction: .3, gravity: 0 },
                smile: 1,
                mainColor: [.98, .96, .96],
                borderColor: [.2, .5, .7],
                isFlatColor: false,
            ...
            function createControls() {
                ...
                gui.add(params, "size", .01, 0.4, .01).onChange(() => {
                    for (let i = 0; i < params.tail.dotsNumber; i++) pointerTrail[i].r = dotSize(i);
                    gl.uniform1f(uniforms.u_size, params.size);
                });
        ...
        <div class="auth-page-wrapper pt-5">
                ...
                <div class="container">
                            ...
                            <div class="text-center mt-3 mb-3">
                                <div style="margin-right: 1%;">
                                    <a href="#" class="d-inline-block auth-logo">
                                        <img src="<?php echo base_url(); ?>assets/images/auth.png" alt="" height="100"
                                            width="250" />
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class='box'>
                        <div class='box-form' style="margin-top: 5%;">
                                ...
                                <div class='fieldset-body' id='login_form'>
                                    <form action="<?php echo base_url('login_data') ?>" method="post"
                                        ...
                                        <p class='field mt-3'>
                                            ...
                                            <input type='text' class="form-control pe-5 rounded-pill" id='username'
                                                style="width: 92%;margin-left: 4.5%;" name="username" title='Username'
                                                autocomplete="off" />
                                        </p>
                                        <p class='field'>
                            ...
                            <img src="<?php echo base_url(); ?>assets/images/horror_peek.png" alt=""
                                class="img-fluid jose-img" id="jose-img" />
                        </div>
                        <span class="text-white d-flex justify-content-center mt-3 mb-5"
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-center flex-wrap gap-4 col-md-12" style="margin-top: 24%;">
                    <?php for ($i = 1; $i <= 9; $i++): ?>
            ...
            <!-- Modal -->
            <div class="fade zoomIn modal1" id="imageModal" tabindex="-1" aria-labelledby="imageModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm">
                    <div class="modal-content">
                        <div class="modal-body">
                            <img src="" class="img-fluid material-shadow" id="modalImage" alt="Preview">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            ...
                            <div id="gameContainer"
                                style="min-height:600px; border:1px solid #ddd; border-radius:10px; padding:10px;">
                                <p class="text-white">No game loaded yet. Pick one above!</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <script>
                function loadGame(game) {
                    ...
                    if (game === 'sudoku') {
                        ...
                        container.innerHTML = `<p class="text-white">Game not available.</p>`;
                    }
                }
            ...
            <script>
                $(document).ready(function () {
                    ...
                    `;
                        ...
                        <marquee scrollamount="15" class="text-white">
                            ${marqueeContent}
                        </marquee>
                    `);
                        }
...
---------------------*/
    ...
    /* 🕸️ Haunted Halloween Button - “Creepy Edition” */
    ...
    .button {
        ...
        text-shadow: 0 0 8px #ff0000, 0 0 20px #ff6600;
    }

    /* Outer creepy borders */
    .button::before,
    .button::after {
        content: '';
        display: block;
    ...
    .button_lg {
        ...
        overflow: hidden;
        border-radius: 6px;
        box-shadow: inset 0 0 15px #000, 0 0 10px #ff0000;
        animation: flickerGlow 3s infinite ease-in-out;
    }

    /* Creeping blood streak slide */
    .button_sl {
        display: block;
        position: absolute;
        top: 0;
        ...
        left: -8px;
        width: 0;
        background: linear-gradient(90deg, #7a0000, #ff3300, #7a0000);
    ...
    .button_text {
        position: relative;
        z-index: 2;
        text-shadow: 0 0 5px #ff3300, 0 0 15px #7a0000, 0 0 25px #ff0000;
    }

    /* Hover Effects: pulse, glow, and expand */
    .button:hover {
        color: #000;
    ...
    .button:hover .button_lg {
        ...
        box-shadow: 0 0 25px #ff2200, inset 0 0 15px #000;
        animation: none;
    }
    ...
    @keyframes flickerGlow {
        ...
        24%,
        55% {
            box-shadow: 0 0 4px #2a0000, inset 0 0 3px #000;
        }
    }

    /* Optional dripping blood text animation */
    @keyframes drip {
        0% {
