...
<html lang="en" data-preloader="enable">
    ...
    <body
        style="background-image: url(<?php echo base_url(); ?>assets/images/christmas.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;">
                ...
                <div class="container">
                    ...
                    <div class='box'>
                        <div class='box-form' style="margin-top: 5%;">
                            ...
                            <img src="<?php echo base_url(); ?>assets/images/santa.png" alt=""
...
---------------------*/
    ...
    /* From Uiverse.io by mrhyddenn — Christmas Edition 🎄 */
    .button {
        -moz-appearance: none;
    ...
    .button_lg {
        ...
        padding: 12px 24px;
        color: #fff;
        background: linear-gradient(135deg, #c40000, #1b5e20);
        border-radius: 8px;
        overflow: hidden;
        box-shadow: 0 0 15px rgba(0, 0, 0, 0.4), inset 0 0 6px rgba(255, 255, 255, 0.2);
    ...
    .button:hover .button_lg {
        background: linear-gradient(135deg, #ff0000, #2e7d32);
    }

    .button:hover .button_lg::before {
        left: 100%;
    }
    ...
    @keyframes sparkle {
        ...
        0%,
        100% {
            text-shadow: 0 0 5px #fff, 0 0 15px #ff0000;
        }

        50% {
            text-shadow: 0 0 10px #fff, 0 0 25px #76ff03;
        }
    }
