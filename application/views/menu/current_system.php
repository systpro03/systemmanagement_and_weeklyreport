        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group">
                    <input type="date" id="date_range_filter" class="form-control"  placeholder="Date Range Filter" data-provider="flatpickr" data-date-format="F j, Y" data-range-date="true" />
            ...
            <div class="modal-body">
                <form id="editDateForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="oldFileDate" data-provider="flatpickr" data-date-format="F j, Y" data-range-date="true" placeholder="Select New Date">
                    </div>
                    <button type="button" class="btn btn-success" onclick="updateFileDate()">Save Changes</button>
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#folderModal">Back to List</button>
                </form>
            </div>
        </div>
    </div>
                ...
                <form id="uploadForm" method="post" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-lg-12" id="isrSearchDiv" style="display: none;">
                            ...
                            <div class="input-group">
                                <input type="search" id="isrSearch" class="form-control" placeholder="Enter ISR Number" autocomplete="off">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="input-group">
                                <input type="date" id="date_" class="form-control" readonly=""  placeholder="Date Range" data-provider="flatpickr" data-date-format="F d, Y" data-range-date="true" />
                                <span class="input-group-text"><i class="ri-calendar-event-line"></i></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12" id="dateImplem" style="display: none;">
                            ...
                            <div class="input-group">
                                <input type="date" id="date_implem" class="form-control" placeholder="Select Date Implemented" data-provider="flatpickr" />
                                <span class="input-group-text"><i class="ri-calendar-event-line"></i></span>
                            </div>
                        </div>
                        <div class="col-lg-12 mt-3">
                            ...
                            <input type="hidden" hidden id="file_business_unitFilter" name="file_business_unitFilter" class="hidden">
                        </div>
                    </div>
                    <div class="modal-footer">
...
<script>
    ...
    $('#file_upload').on('show.bs.modal', function () {
        ...
        $('#directory').change(function () {
            $('#business_unitFilter1, #departmentFilter, #date_').prop('disabled', !$(this).val());
        });
        $('#business_unitFilter1, #departmentFilter, #date_').prop('disabled', !$('#directory').val());
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                    ...
                    paginatedFiles.forEach(function (file) {
                        ...
                        <div class="element-item col-xxl-2 col-xl-2 col-sm-6">
                            <div class="gallery-box card">`;
                                ...
                                modalContent += `
                                    <div class="ribbon bg-info" style="position: absolute; top: 0; right: 0; padding: 2px 8px; border-top-right-radius: 8px; border-bottom-left-radius: 8px; color: #fff;">
                                        ${file.mod_abbr}
                                    </div>`;
                            ...
                            modalContent += `<div class="gallery-container">
                                    ${['jpg', 'jpeg', 'png', 'gif', 'jfif'].includes(fileExtension) ? `
                                        <a class="image-popup" href="${base_url}open_image/${folderName}/${file.name}" target="_blank" title="${file.name}" data-bs-toggle="tooltip" data-bs-placement="top">
                                            <img src="${base_url}open_image/${folderName}/${file.name}" style="width: 100%; height: 150px; background-size: cover; background-repeat: no-repeat !important;" />
                ...
                if (totalPages > 1) {
                    ...
                    if (page > 1) {
                        modalContent += `<button class="btn btn-sm btn-outline-primary" 
                                            onclick="updateFolderModalContent('${folderName}', '${team}', '${module}', '${sub_module}', '${business_unit}', '${department}', ${page - 1}, '${date}')">
                                            Prev
                                        </button> `;
                    }
